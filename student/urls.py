...
urlpatterns = [
	...
	url(r'^student_desk/create_profile/$', views.create_profile, name='create_profile'),
	url(r'^student_desk/update_profile/(?P<id>\d+)/$', views.update_profile, name='update_profile'),
	url(r'^student_desk/profile/$', views.profile, name='profile'),
